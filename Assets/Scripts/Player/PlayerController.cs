//Modified based on https://github.com/striderzz/2D-Platformer-Unity/tree/main
...
public class PlayerController : MonoBehaviour
{
    ...
    private float nextFireTime = 5f; // Time of the next allowed shot
    ...
    private void Update()
    {
        ...
        if (!isPaused)
        {
            ...
            // Handle shooting
            if (controlmode == Controls.pc && Input.GetKeyDown("j") && Time.time >= nextFireTime)
            {
                Shoot();
    ...
    private bool IsGrounded()
    {
        ...
        Vector2 rayOrigin = new Vector2(groundCheck.transform.position.x, groundCheck.transform.position.y);
